...
//    }
    ...
    public String pobierzKontoDoEdycji(Konto Konto) throws DbException.BadExecution {
    ...
    public String zmienMojeHaslo(String stare, String nowe) throws DbException.BadExecution {
